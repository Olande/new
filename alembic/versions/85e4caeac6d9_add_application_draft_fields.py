...
down_revision: Union[str, Sequence[str], None] = '6c509e73e48d'
...
def upgrade() -> None:
    ...
    op.add_column('applications', sa.Column('cover_letter_draft', sa.Text(), nullable=True))
    op.add_column('applications', sa.Column('revision_count', sa.Integer(), server_default='0', nullable=False))
    ...
    op.drop_index(op.f('idx_jobs_skills_bm25'), table_name='jobs', postgresql_with={'text_config': 'english'}, postgresql_using='bm25')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(op.f('idx_jobs_skills_bm25'), 'jobs', ['skills_text'], unique=False, postgresql_with={'text_config': 'english'}, postgresql_using='bm25')
