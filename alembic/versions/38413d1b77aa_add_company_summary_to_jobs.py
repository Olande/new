"""Add company_summary to jobs

Revision ID: 38413d1b77aa
Revises: 85e4caeac6d9
Create Date: 2026-07-06 21:21:45.169858
...
revision: str = "38413d1b77aa"
down_revision: Union[str, Sequence[str], None] = "85e4caeac6d9"
...
def upgrade() -> None:
    ...
    op.add_column("jobs", sa.Column("company_summary", sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("jobs", "company_summary")
    op.create_table(
        "checkpoint_blobs",
