...
async def main():
    try:
        ...
        v2 = await client.aembed_query(
            "experienced python developer working on backend systems"
        )
        v3 = await client.aembed_query(
            "senior software engineer role using python and django"
        )
